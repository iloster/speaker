...
-->
  ...
  <div class="nav1">
	<ul class="flexy-menu orange">
		...
		<li class="active"><a href="__URL__/speaker/string/Found"><i class="icon-th"></i>寻物招领</a></li>
...
<div class="form-speaker">
  ...
  <div class="form-class">
    <div id="collapseOne" class="collapse">
      <form action="__URL__/speaker_insert/string/Found" class="form-horizontal" method="post">
  ...
  <div class="table-speaker">
      <table class="table table-hover table-bordered"  style="word-break:break-all; word-wrap:break-all;">
           ...
           <?php if(is_array($data)): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
               ...
               <td><a href="__URL__/speaker_del/string/Found/id/<?php echo ($vo["id"]); ?>">删除</a></td>
